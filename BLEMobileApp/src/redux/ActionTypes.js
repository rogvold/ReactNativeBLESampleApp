...
export const LOAD_USER_POINTS_IN_RANGE = 'LOAD_USER_POINTS_IN_RANGE'
export const LOAD_USER_POINTS_IN_RANGE_SUCCESS = 'LOAD_USER_POINTS_IN_RANGE_SUCCESS'
export const LOAD_USER_POINTS_IN_RANGE_FAIL = 'LOAD_USER_POINTS_IN_RANGE_FAIL'
...
export const SCAN_BLUETOOTH_DEVICES_SUCCESS = 'SCAN_BLUETOOTH_DEVICES_SUCCESS'
export const SCAN_BLUETOOTH_DEVICES_FAIL = 'SCAN_BLUETOOTH_DEVICES_FAIL'

export const CONNECT_TO_DEVICE = 'CONNECT_TO_DEVICE'
export const CONNECT_TO_DEVICE_SUCCESS = 'CONNECT_TO_DEVICE_SUCCESS'
export const CONNECT_TO_DEVICE_FAIL = 'CONNECT_TO_DEVICE_FAIL'

export const DISCONNECT_DEVICE = 'DISCONNECT_DEVICE'
export const DISCONNECT_DEVICE_SUCCESS = 'DISCONNECT_DEVICE_SUCCESS'
export const DISCONNECT_DEVICE_FAIL = 'DISCONNECT_DEVICE_FAIL'

//ble fake
export const TURN_ON_FAKE = 'TURN_ON_FAKE'
export const TURN_OFF_FAKE = 'TURN_OFF_FAKE'
//


export const SAVE_RR_DATA = 'SAVE_RR_DATA'

//RECORDING
export const UPLOAD_POINTS_TO_SERVER = 'UPLOAD_POINTS_TO_SERVER'
export const UPLOAD_POINTS_TO_SERVER_SUCCESS = 'UPLOAD_POINTS_TO_SERVER_SUCCESS'
export const UPLOAD_POINTS_TO_SERVER_FAIL = 'UPLOAD_POINTS_TO_SERVER_FAIL'

export const START_SESSION = 'START_SESSION'
export const START_SESSION_SUCCESS = 'START_SESSION_SUCCESS'
export const START_SESSION_FAIL = 'START_SESSION_FAIL'

export const STOP_SESSION = 'STOP_SESSION'
export const STOP_SESSION_SUCCESS = 'STOP_SESSION_SUCCESS'
export const STOP_SESSION_FAIL = 'STOP_SESSION_FAIL'
